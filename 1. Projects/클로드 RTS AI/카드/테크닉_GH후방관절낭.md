...
책_페이지: 3~5페이지 (내회전 개선을 위한 테크닉)
테크닉_유형: [ART, MET]
ART_개수: 1
MET_개수: 1
날짜: 4/10
의심근육→: [극하근(카드없음), 소원근(카드없음), 후면삼각근(카드없음)]
테크닉→: 미기재
재검사→: [내회전 검사]
출처: "4.10.md 강의 전사 원본 (소책자 3~5페이지 해당 구간)"
검증상태: 전사원문확인
...
## 체인 링크
- **의심근육→** 극하근(카드없음) · 소원근(카드없음) · 후면삼각근(카드없음) — 후방 관절낭을 풀면 함께 이완되는 더 바깥쪽 조직들 (원문: "얘네들이 좀 더 밖에 있으니까")
