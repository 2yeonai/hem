---
name: daily-session-log-v2
description: 매일 4:00 오늘 세션 요약을 2. Areas/Claude 세션로그/에 저장 (모델: Sonnet 5)
---

모델: 이 작업은 반드시 Sonnet 5 모델로 실행한다. (이 작업은 사실 기록 위주의 정형화된 요약 작업이라 고비용 모델이 필요 없다 — Fable 5 등 고비용 모델로 절대 에스컬레이션하지 말 것.)
